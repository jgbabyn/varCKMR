###This reruns things for the new Ne form
...
## 	    library(tidyverse)
	...
	growth_rateEstMB$trueGR = popPar$growth_rate
          ...
          N_eEstMB = data.frame(estN_e = ssdrMB[rownames(ssdrMB) == "Ne_engen",1],stdErr = ssdrMB[rownames(ssdrMB) == "Ne_engen",2])
          N_eEstMB$estN_e = reportMB$Ne_engen
	...
	growth_rateEstMVP2$trueGR = popPar$growth_rate
          ...
          N_eEstMVP2 = data.frame(estN_e = reportMVP2$Ne_engen)
          N_eEstMVP2$stdErr = ssdrMVP2[rownames(ssdrMVP2) == "Ne_engen",2]
	...
	growth_rateEstMVP1$trueGR = popPar$growth_rate
          ...
          N_eEstMVP1 = data.frame(estN_e = ssdrMVP1[rownames(ssdrMVP1) == "Ne_engen",1],stdErr = ssdrMVP1[rownames(ssdrMVP1) == "Ne_engen",2])
          N_eEstMVP1$estN_e = reportMVP1$Ne_engen
	...
	ret = list(optMB=optMB,convergedMB=optMB$convergence,reportMB=reportMB,NestMB=NestMB,MestMB=MestMB,FecEstMB=FecEstMB,thetaEstMB=thetaEstMB,VkEstMB=VkEstMB,
		   growth_rateEstMB=growth_rateEstMB,N_eEstMB=N_eEstMB,
		    optMVP2=optMVP2,convergedMVP2=optMVP2$convergence,reportMVP2=reportMVP2,NestMVP2=NestMVP2,MestMVP2=MestMVP2,FecEstMVP2=FecEstMVP2,thetaEstMVP2=thetaEstMVP2,VkEstMVP2=VkEstMVP2,
		   growth_rateEstMVP2=growth_rateEstMVP2,N_eEstMVP2=N_eEstMVP2,
		    optMVP1=optMVP1,convergedMVP1=optMVP1$convergence,reportMVP1=reportMVP1,NestMVP1=NestMVP1,MestMVP1=MestMVP1,FecEstMVP1=FecEstMVP1,thetaEstMVP1=thetaEstMVP1,VkEstMVP1=VkEstMVP1,
	  ...
	  saveRDS(ret2,file=paste0("../senanalysisresults.rds"))
