...
pop_files = c("../populations/pop0013.rds","../populations/pop0014.rds","../populations/pop0015.rds","../populations/pop0016.rds","../populations/pop0017.rds","../populations/pop0018.rds")
...
for(i in 1:length(pop_files)){
    ...
    if(!dir.exists(paste0("../LDNEsamples/","LDNEPOP",str_pad(i+12,4,pad="0")))){
        dir.create(paste0("../LDNEsamples/","LDNEPOP",str_pad(i+12,4,pad="0")))
    }
    savepath = paste0("../LDNEsamples/","LDNEPOP",str_pad(i+12,4,pad="0"))
...
saveRDS(LDNEscom,paste0(savepath,"/LDNEcom",str_pad(i+12,width=4,pad=0),".rds"))
}
