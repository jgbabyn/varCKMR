...
pop_files = c("../populations/pop0015.rds")
...
for(i in 1:length(pop_files)){
    ...
    if(!dir.exists(paste0("../LDNEsamples/","LDNEPOP",str_pad(i+14,4,pad="0")))){
        dir.create(paste0("../LDNEsamples/","LDNEPOP",str_pad(i+14,4,pad="0")))
    }
    savepath = paste0("../LDNEsamples/","LDNEPOP",str_pad(i+14,4,pad="0"))
...
saveRDS(LDNEscom,paste0(savepath,"/LDNEcom",str_pad(i+14,width=4,pad=0),".rds"))
}
