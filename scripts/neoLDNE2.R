...
pop_files = c("../populations/pop0007.rds","../populations/pop0008.rds","../populations/pop0009.rds","../populations/pop0010.rds","../populations/pop0011.rds","../populations/pop0012.rds")
...
for(i in 1:length(pop_files)){
    ...
    if(!dir.exists(paste0("../LDNEsamples/","LDNEPOP",str_pad(i+6,4,pad="0")))){
        dir.create(paste0("../LDNEsamples/","LDNEPOP",str_pad(i+6,4,pad="0")))
    }
    savepath = paste0("../LDNEsamples/","LDNEPOP",str_pad(i+6,4,pad="0"))
...
saveRDS(LDNEscom,paste0(savepath,"/LDNEcom",str_pad(i+6,width=4,pad=0),".rds"))
}
