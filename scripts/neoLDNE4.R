...
pop_files = c("../populations/pop0019.rds","../populations/pop0020.rds","../populations/pop0021.rds")
...
for(i in 1:length(pop_files)){
    ...
    if(!dir.exists(paste0("../LDNEsamples/","LDNEPOP",str_pad(i+18,4,pad="0")))){
        dir.create(paste0("../LDNEsamples/","LDNEPOP",str_pad(i+18,4,pad="0")))
    }
    savepath = paste0("../LDNEsamples/","LDNEPOP",str_pad(i+18,4,pad="0"))
...
saveRDS(LDNEscom,paste0(savepath,"/LDNEcom",str_pad(i+18,width=4,pad=0),".rds"))
}
